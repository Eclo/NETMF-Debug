...
{
    public class RuntimeValue_Class<T> : RuntimeValue<T> where T : MFDevice
    {
        protected internal RuntimeValue_Class(Engine<T> eng, WireProtocol.Commands.Debugging_Value handle) : base(eng, handle)
        {
        }
