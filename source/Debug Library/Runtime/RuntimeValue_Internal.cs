...
{
    public class RuntimeValue_Internal<T> : RuntimeValue<T> where T : MFDevice
    {
        protected internal RuntimeValue_Internal(Engine<T> eng, WireProtocol.Commands.Debugging_Value handle) : base(eng, handle)
        {
        }
